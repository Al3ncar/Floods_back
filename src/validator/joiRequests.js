...
const requestSchema = Joi.object({
  requester_id: Joi.number().integer().required().messages({
    "number.base": "O requester_id deve ser um número",
    "number.integer": "O requester_id deve ser um número inteiro",
    "any.required": "O requester_id é obrigatório",
  }),
